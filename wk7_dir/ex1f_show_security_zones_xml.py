...
trust_zone = my_xml[0]
#trust_zone = my_xml.findall(".//zones-security")[0] 
#print('1', trust_zone.getchildren()[0].tag)
#print('2', trust_zone[0].tag)
#print('3', trust_zone.findall(".//zones-security-zonename")[0].tag)
for i in trust_zone.iterchildren():
    print(i.tag)
